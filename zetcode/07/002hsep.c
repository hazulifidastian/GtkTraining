...
giving off fumes of zinc oxide. It reacts with acids, \
alkalis and other non-metals. If not completely pure, zinc reacts \
...
the bloodstream, as a co-factor in various enzymes, \
and in copper-based pigments. However, in sufficient amounts, \
